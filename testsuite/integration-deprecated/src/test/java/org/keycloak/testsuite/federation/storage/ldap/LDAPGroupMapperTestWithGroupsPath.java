...
public class LDAPGroupMapperTestWithGroupsPath {
    ...
    static class GroupTestKeycloakSetup extends KeycloakRule.KeycloakSetup {
        ...
        public void config(RealmManager manager, RealmModel adminstrationRealm, RealmModel appRealm) {
            ...
            appRealm.addDefaultGroup(KeycloakModelUtils.findGroupByPath(appRealm, LDAP_GROUPS_PATH + "/defaultGroup1/defaultGroup11"));
            appRealm.addDefaultGroup(KeycloakModelUtils.findGroupByPath(appRealm, LDAP_GROUPS_PATH + "/defaultGroup1/defaultGroup12"));
        ...
        void postSetup(RealmModel appRealm, LDAPStorageProvider ldapProvider) {
            LDAPGroupMapperTestWithGroupsPath.ldapModel = this.ldapModel;
            LDAPGroupMapperTestWithGroupsPath.descriptionAttrName = this.descriptionAttrName;
        }
    ...
    public void test01_ldapOnlyGroupMappings() {
        ...
        try {
            ...
            GroupModel group1 = KeycloakModelUtils.findGroupByPath(appRealm, LDAP_GROUPS_PATH + "/group1");
            john.joinGroup(group1);

            // This group should already exists as it was imported from LDAP
            GroupModel group11 = KeycloakModelUtils.findGroupByPath(appRealm, LDAP_GROUPS_PATH + "/group1/group11");
            mary.joinGroup(group11);

            // This group should already exists as it was imported from LDAP
            GroupModel group12 = KeycloakModelUtils.findGroupByPath(appRealm, LDAP_GROUPS_PATH + "/group1/group12");
    ...
    public void test04_groupReferencingNonExistentMember() {
        ...
        try {
            ...
            GroupModel kcGroup2 = KeycloakModelUtils.findGroupByPath(appRealm, LDAP_GROUPS_PATH + "/group2");
    ...
    public void test06_addingUserToNewKeycloakGroup() throws Exception {
        ...
        try {
            ...
            GroupModel group4 =  KeycloakModelUtils.findGroupByPath(appRealm, LDAP_GROUPS_PATH + "/group4");
            john.joinGroup(group4);

            GroupModel group31 = KeycloakModelUtils.findGroupByPath(appRealm, LDAP_GROUPS_PATH + "/group3/group31");
            GroupModel group32 = KeycloakModelUtils.findGroupByPath(appRealm, LDAP_GROUPS_PATH + "/group3/group32");

            john.joinGroup(group31);
            john.joinGroup(group32);

            GroupModel group14 = KeycloakModelUtils.findGroupByPath(appRealm, LDAP_GROUPS_PATH + "/group1/group14");
        ...
        try {
            ...
            GroupModel group14 =  KeycloakModelUtils.findGroupByPath(appRealm, LDAP_GROUPS_PATH + "/group1/group14");
            GroupModel group3 =  KeycloakModelUtils.findGroupByPath(appRealm, LDAP_GROUPS_PATH + "/group3");
            GroupModel group31 = KeycloakModelUtils.findGroupByPath(appRealm, LDAP_GROUPS_PATH + "/group3/group31");
            GroupModel group32 = KeycloakModelUtils.findGroupByPath(appRealm, LDAP_GROUPS_PATH + "/group3/group32");
            GroupModel group4 =  KeycloakModelUtils.findGroupByPath(appRealm, LDAP_GROUPS_PATH + "/group4");
    ...
    public void test07_newUserDefaultGroupsImportModeTest() throws Exception {
        ...
        try {
            ...
            GroupModel defaultGroup11 =  KeycloakModelUtils.findGroupByPath(appRealm, LDAP_GROUPS_PATH + "/defaultGroup1/defaultGroup11");
            Assert.assertNotNull(defaultGroup11);

            GroupModel defaultGroup12 =  KeycloakModelUtils.findGroupByPath(appRealm, LDAP_GROUPS_PATH + "/defaultGroup1/defaultGroup12");
