...
public class LDAPGroupMapperSyncTestWithGroupsPath {
    ...
    public void before() {
        ...
        try {
            ...
            Set<GroupModel> kcGroups = KeycloakModelUtils.findGroupByPath(realm, LDAP_GROUPS_PATH).getSubGroups();
    ...
    public void test03_syncWithDropNonExistingGroups() throws Exception {
        ...
        try {
            ...
            GroupModel groupsPath = KeycloakModelUtils.findGroupByPath(realm, LDAP_GROUPS_PATH);
            GroupModel model1 = realm.createGroup("model1");
            realm.moveGroup(model1, groupsPath);
    ...
    public void test04_syncNoPreserveGroupInheritanceWithLazySync() throws Exception {
        ...
        try {
            ...
            GroupModel group1 = KeycloakModelUtils.findGroupByPath(realm, LDAP_GROUPS_PATH + "/group1");
            GroupModel group11 = KeycloakModelUtils.findGroupByPath(realm, LDAP_GROUPS_PATH + "/group11");
            GroupModel group12 = KeycloakModelUtils.findGroupByPath(realm, LDAP_GROUPS_PATH + "/group12");
